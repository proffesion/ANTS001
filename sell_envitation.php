                  ...
                  <div class="col-xs-5">
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          ...
                          <select id="paymentType" name="paym_typ" class="form-control" onchange="processF()" required>
                  ...
                  <div class="col-xs-4">
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          ...
                          <input type="number" step="any" class="form-control" name="quantity" id="quantity" value="1" min="1" onkeyup="processF()" <?php echo $form_number; ?>>
                        </div>
                      </div>
                ...
                <div class="col-xs-6 puRwGrpup col-md-4 frw-cont">
                  <div class="form-group has-feedback">
                      <div class="input-group">
                        ...
                        <input type="number" step="any"  class="form-control" name="PU_Rw" id="priceUnitR" onkeyup="processF()" min="0"  value="<?php echo fileData('price_r',$env_id); ?>" aria-describedby="" <?php echo $form_number; ?>>
                      </div>
                      <span id="" class="sr-only">(success)</span>
                    </div>
                </div>
                ...
                <div class="col-xs-6 col-md-4 dol-cont">
                  <div class="form-group puDolGrpup has-feedback">
                      <div class="input-group">
                        ...
                        <input type="number" step="any"  class="form-control" id="priceUnitD" name="PU_Dol" onkeyup="processF()" min="0"  value="<?php echo fileData('price_d',$env_id); ?>" aria-describedby="" <?php echo $form_number; ?>>
                      </div>
                      <span id="" class="sr-only">(success)</span>
                    </div>
                </div>
                ...
                <div class="col-xs-6 col-md-4 fc-cont">
                  <div class="form-group puFcGrpup has-feedback">
                      <div class="input-group">
                        ...
                        <input type="number" step="any"  class="form-control" id="priceUnitFc" name="PU_Fc" onkeyup="processF()" value="0" min="0"  aria-describedby="" <?php echo $form_number; ?>>
                      </div>
                      <span id="" class="sr-only">(success)</span>
                  </div>
                ...
                <div class="col-xs-6 col-md-4">
                  ...
                  <!-- end of popover -->
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          <span class="input-group-addon">Fco</span>
                          <input type="number" step="any"  class="form-control" name="Pay_fc" id="inCashFc" value="0" onkeyup="processF()" min="0" data-toggle="inCashFc" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                        <span id="" class="sr-only">(success)</span>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Rw</label>
                        <input type="number" step="any"  class="form-control form-hide form-small" id="rateRw" name="Rate_R" min="0" value="<?php echo retrieve_data('rec_dol_rw','taux','id','1'); ?>" onkeyup="processF()" required <?php echo $form_number; ?>>
                      </div>
                  </div>
                  <div class="col-md-6"  style="padding: 0;">
                    <div class="form-group" style="padding: 0;">
                      <label for="">Fco</label>
                      <input type="number" step="any"  class="form-control form-hide form-small"  id="rateCo" name="Rate_Fc" min="0" value="<?php echo retrieve_data('rec_dol_fc','taux','id','1'); ?>" onkeyup="processF()" required <?php echo $form_number; ?>>
                    </div>
                  </div>
                </div>
