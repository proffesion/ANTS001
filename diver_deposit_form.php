...
?>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="diver_deposit_form.php?date=<?php echo $yesterday_date; ?>">Yesterday</a></li>
        <li><a href="diver_deposit_form.php">Today</a></li>
      </ul>
        <form class="navbar-form navbar-left" action="diver_deposit_form.php" method="get">
        ...
        <select name="" class="form-control" id="printTypeSel" onchange="printDeposit()">
          ...
          <option value="invitation">Divers</option>
          <option value="balance">Balance</option>
          <option value="IB">Diver & Bal </option>
...
<?php
  ...
  <?php
   ...
   <tr class="no-border">
     ...
     <td bgcolor="lightblue"> <b> <?php echo @$total_Pay_Fr_incr; ?> Frw</b> </td>
     <td bgcolor="lightblue"> <b> <?php echo @$total_Pay_dol_incr; ?> $</b> </td>
     <td bgcolor="lightblue"> <b> <?php echo @$total_Pay_Fc_incr; ?> Fco</b> </td>
...
<!-- ========================================================================================================================= -->
<div class="deposit-div-containner balance-deposit  null-hide">
  <h2>Balance/Diver</h2>
<?php @$BalanceQuerySearch = "SELECT * FROM `balance_table` WHERE `item`='Divers' AND `date`='$date_Q'"; ?>

  <table class="table no-bottom-border" border="1">
    <tbody>
      <tr>
        <th> # </th>
        <th> Date </th>
...
<div class="paper-containner null-hide deposit-form-table" style="">
   ...
   <h1 class="head-txt" style="color:red;">Deposit form/Diver</h1>
   <table border="1" class="deposit-table deposit-part-one" width="100%" height="306px">
     ...
     <tr>
       ...
       <tr>
         ...
         <td style="text-align:center;"> <label>
           <?php
             @$total_Pay_Fr_incr_Bal = $total_Pay_Fr_incr + $total_Bal_Pay_Fr;
             echo @$total_Pay_Fr_incr_Bal;
           ?> Frw</label> </td>
         <td style="text-align:center;"> - </td>
         <td style="text-align:center;"> <label><?php echo @$total_Pay_Fr_incr_Bal; ?> Frw</label>  </td>
       </tr>
       ...
       <tr>
         ...
         <td style="text-align:center;"> <label>
           <?php
              @$Price_total_Rw_incr_Bal = @$Price_total_Rw_incr + @$total_Bal_Total_Available_Rw;
              echo @$Price_total_Rw_incr_Bal;
           ?>
           Frw</label> </td>
       </tr>
...
<table border="1" class="deposit-table" width="75%" height="206px">
  <tr>
    ...
    <td> &nbsp; &nbsp; &nbsp; <label><?php echo @$exedentSum; ?> Frw</label> &nbsp; &nbsp; <label> <?php //echo @$manqSum; ?> </label> </td>
  </tr>
  <tr>
