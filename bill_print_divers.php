...
<?php
  ...
  $date_Query = "SELECT * FROM `divers_sales` WHERE `s_id`='$selected_id' LIMIT 1";
...
<label class="label-v">Product:</label> <label class="value"><?php echo @retrieve_data('pro_name','products','pro_id',$div_id); ?></label> <hr>
...
<label class="label-v">Done By:</label> <label class="value">#<?php echo @$done_by; ?></label> <hr>
</section>
