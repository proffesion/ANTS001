...
$pro_id = retrieve_data('div_id','divers_sales','s_id',$sell_id);


// FIND THE BALANCE
$Paymnt_type = retrieve_data('paym_typ','divers_sales','s_id',$sell_id);
$Db_balance = retrieve_data('balance','divers_sales','s_id',$sell_id);
...
// FIND THE PRICE UNIT
$PU_ch = retrieve_data('PU','divers_sales','s_id',$sell_id);
...
<form class="" action="saleDivers_update.php?id=<?php echo $sell_id; ?>" method="post">
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-md-10">
            <h3 style="padding-left: 23px;">WARNING!!</h3>
                <ul>
                  <li>The change you will make here, will not be updated in others tables <br></li>
                  <li>if you are working with the <b>Sell Quantity</b>,
                    you may also update the stock <b>Quantity</b><a href="updateProduct.php?id=<?php echo @$sell_id; ?>">Click here</a><br>
...
if (isset($_POST['Sell_envitation'])) {
 ...
 @$Bal_fc = $_POST['Bal_fc'];
   ...
   $curent_date_db = retrieve_data('date','divers_sales','s_id',$sell_id);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content modal-styled-success">
      ...
      <div class="modal-body">
        ...
        <p>if you did some change on quantity, <a href="updateProduct.php?id=<?php echo @$sell_id; ?>">Click here to update the stock </a></p>
      </div>
      <div class="modal-footer">
      <a href="updateProduct.php?id=<?php echo @$sell_id; ?>">
   ...
   <div class="section-one" style="background: #ececec;">
          ...
          <div class="col-md-4">
            <div class="form-group has-feedback">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="client_name" value="<?php echo retrieve_data('client_name','divers_sales','s_id',$sell_id); ?>" id="" placeholder=" Name" title="Text only" minlength="3" required="" <?php echo $form_text; ?>>
                </div>
          ...
          <div class="col-md-4">
            ...
            <div class="form-group has-feedback">
                <div class="input-group">
                  ...
                  <input type="text" name="done_by" class="form-control" value="<?php $sell_done_by = retrieve_data('done_by','divers_sales','s_id',$sell_id); echo retrieve_data('lname','users','user_id',$sell_done_by); ?>" id="" placeholder="" readonly="">
                </div>
              </div>
          ...
          <div class="col-md-4">
            ...
            <div class="input-group">
              ...
              <select class="form-control" name="maison_id" required="">
                  <?php
                     $maison = retrieve_data('maison_id','divers_sales','s_id',$sell_id);
        ...
        <div class="date-edit-cont">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="" class="form-control" value="<?php echo retrieve_data('date','divers_sales','s_id',$sell_id); ?>" id="" placeholder="" readonly="">
                </div>
              </div>
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          ...
                          <select id="paymentType" name="paym_typ" class="form-control" onchange="sellUpdateProcessF()">
                            <option value="<?php echo retrieve_data('paym_typ','divers_sales','s_id',$sell_id); ?>"><?php echo retrieve_data('paym_typ','divers_sales','s_id',$sell_id); ?></option>
                  ...
                  <div class="col-xs-6">
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          ...
                          <input type="number" class="form-control" name="quantity" id="quantity" value="<?php echo retrieve_data('quantity','divers_sales','s_id',$sell_id); ?>" onkeyup="sellUpdateProcessF()" <?php echo $form_number; ?>>
                        </div>
                      </div>
              ...
              <div class="row">
                <div class="col-xs-6 col-md-4">
                  ...
                  <!-- end of popover -->
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          <span class="input-group-addon">Frw</span>
                          <input type="number" step="any" class="form-control" id="inCashRw" name="Pay_Fr" value="<?php echo retrieve_data('Pay_Fr','divers_sales','s_id',$sell_id); ?>" onkeyup="sellUpdateProcessF()" data-toggle="inCashRw" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                ...
                <div class="col-xs-6 col-md-4">
                  ...
                  <div class="form-group has-feedback">
                      <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="number" step="any" class="form-control" name="Pay_Dol" id="inCashDol" value="<?php echo retrieve_data('Pay_Dol','divers_sales','s_id',$sell_id); ?>" onkeyup="sellUpdateProcessF()" data-toggle="inCashDol" aria-describedby="" <?php echo $form_number; ?>>
                      </div>
                      <span id="" class="sr-only">(success)</span>
                  </div>
                ...
                <div class="col-xs-6 col-md-4">
                  ...
                  <!-- end of popover -->
                    ...
                    <div class="form-group has-feedback">
                        <div class="input-group">
                          <span class="input-group-addon">Fco</span>
                          <input type="number" step="any" class="form-control" name="Pay_fc" id="inCashFc" value="<?php echo retrieve_data('Pay_fc','divers_sales','s_id',$sell_id); ?>" onkeyup="sellUpdateProcessF()" data-toggle="inCashFc" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                        <span id="" class="sr-only">(success)</span>
                    </div>
...
<div>
              ...
              <hr class="separator">
               ...
               <div class="col-md-12">
                     ...
                     <b>Comment</b>
                     <textarea class="form-control" rows="" name="comment" cols=""><?php echo retrieve_data('comment','divers_sales','s_id',$sell_id); ?></textarea>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        <label for="">Rw</label>
                        <input type="number" step="any" class="form-control form-hide form-small" id="rateRw" name="Rate_R" value="<?php echo retrieve_data('Rate_R','divers_sales','s_id',$sell_id); ?>" onkeyup="sellUpdateProcessF()" required <?php echo $form_number; ?>>
                      </div>
                  </div>
                  <div class="col-md-6"  style="padding: 0;">
                    <div class="form-group" style="padding: 0;">
                      <label for="">Fco</label>
                      <input type="number" step="any" class="form-control form-hide form-small"  id="rateCo" name="Rate_Fc" value="<?php echo retrieve_data('Rate_Fc','divers_sales','s_id',$sell_id); ?>" onkeyup="sellUpdateProcessF()" required <?php echo $form_number; ?>>
                    </div>
                  </div>
                </div>
                ...
                <div class="price-total">
                    ...
                    <div class="form-group has-success has-feedback">
                        <div class="input-group">
                          ...
                          <input type="number" step="any" class="form-control form-hide"  name="Price_total" id="totalPrice" value="<?php echo retrieve_data('Price_total','divers_sales','s_id',$sell_id); ?>" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-success has-feedback">
                        <div class="input-group">
                          <span class="input-group-addon">Frw</span>
                          <input type="number" step="any" class="form-control form-hide" name="Price_total_Rw" id="totalPriceRw" value="<?php echo retrieve_data('Price_total_Rw','divers_sales','s_id',$sell_id); ?>" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                    </div>
                </div>
                ...
                <div class="price-total">
                    ...
                    <div class="form-group has-success has-feedback">
                        <div class="input-group">
                          ...
                          <input type="number" step="any" class="form-control form-hide" name="Total_Available" id="totalAvailable" value="<?php echo retrieve_data('Total_Available','divers_sales','s_id',$sell_id); ?>" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-success has-feedback">
                        <div class="input-group">
                          <span class="input-group-addon">Frw</span>
                          <input type="number" step="any" class="form-control form-hide" name="Total_Available_Rw" id="totalAvailableRw" value="<?php echo retrieve_data('Total_Available_Rw','divers_sales','s_id',$sell_id); ?>" aria-describedby="" <?php echo $form_number; ?>>
                        </div>
                    </div>
                </div>
                <br>
